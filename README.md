...
- **Recurrings**: сколько осталось заплатить и сколько уже ушло, плитки платежей месяца.
  ...
  или с той же суммой в той же категории. Кнопка «+» добавляет платёж — название, эмодзи, сумму,
  день месяца и категорию, — нажатие на плитку открывает правку и удаление. Платёж на 29–31-е
  в коротком месяце приходится на его последний день.
